    ...
    return (
        <>
            <div className="container p-3 p-md-5 mt-5">
                ...
                {/* FIX: Changed mx-5 to mx-0 mx-md-5 so it doesn't crush mobile screens */}
                <div className="row p-3 p-md-5 mt-md-5 border-top text-muted mx-0 mx-md-5" style={{fontSize: "1.06rem", lineHeight: "1.8"}}>
                    
                    {/* FIX: Made column responsive */}
